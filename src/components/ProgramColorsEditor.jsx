...
import { ProgramColorsContextMenu } from './menus/context.js';
import { styles } from '../styles/program-colors.js';
...
class PcCellFormatter extends React.Component{
  onClick(){
    console.log(this);
  }
  render(){
...
class ReactiveBtn extends React.Component{
  render(){
...
export class ProgramColorsEditor extends React.Component{
  getInitialState(){
    var temp = {};
    return {
...
module.exports = ProgramColorsEditor;
